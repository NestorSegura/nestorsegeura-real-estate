  ...
  enabled.forEach((block, index) => {
    ...
    switch (block._type) {
      case 'heroSection':
        ...
        break
      case 'featureStrip':
        elements.push(<FeatureStrip key={block._key} {...(block as Parameters<typeof FeatureStrip>[0])} />)
        break
      case 'testimonialsBlock':
        elements.push(<TestimonialsBlock key={block._key} {...(block as Parameters<typeof TestimonialsBlock>[0])} />)
        break
      case 'ctaBlock':
        elements.push(<CtaBlock key={block._key} {...(block as Parameters<typeof CtaBlock>[0])} />)
        break
      case 'problemSolutionBlock':
        elements.push(<ProblemSolutionBlock key={block._key} {...(block as Parameters<typeof ProblemSolutionBlock>[0])} />)
        break
      case 'servicesBlock':
        elements.push(<ServicesBlock key={block._key} {...(block as Parameters<typeof ServicesBlock>[0])} />)
        break
      case 'faqBlock':
        elements.push(<FaqBlock key={block._key} {...(block as Parameters<typeof FaqBlock>[0])} />)
        break
      case 'referencesBlock':
        elements.push(<ReferencesBlock key={block._key} {...(block as Parameters<typeof ReferencesBlock>[0])} />)
        break
      default:
